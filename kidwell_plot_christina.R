...
# CR I'm getting the error that object 'journal' is not found - I'm not sure what the difference between an object and a variable is - is select the wrong function to use here?
