...
author: 
  - name          : "Christina Rochios"
    affiliation   : "1"
    corresponding : no    # Define only one corresponding author
    email         : "c.rochios@unsw.edu.au"
  - name          : "Jenny L. Richmond"
    affiliation   : "1"
    corresponding : yes    # Define only one corresponding author
    address       : "School of Psychology, University of New South Wales, Sydney 2052, AUSTRALIA"
...
```{r, out.width="49%", out.height="20%", fig.cap = "", fig.show='hold'}
