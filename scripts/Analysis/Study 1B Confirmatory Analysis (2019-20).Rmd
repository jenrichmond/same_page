...
ttest1 <- t_test(total_data_score ~ subfield_groups, devcog_data, paired = FALSE)
...
ttest2 <- t_test(total_data_score ~ subfield_groups, devsocial_data, paired = FALSE)
...
ttest3 <- t_test(total_data_score ~ subfield_groups, devother_data, paired = FALSE)
...
ttest4 <- t_test(total_materials_score ~ subfield_groups, devcog_materials, paired = FALSE)
...
ttest5 <- t_test(total_materials_score ~ subfield_groups, devsocial_materials, paired = FALSE)
...
ttest6 <- t_test(total_materials_score ~ subfield_groups, devother_materials, paired = FALSE)
...
ttest7 <- t_test(total_data_score ~ time_period, second2019_first2020, paired = FALSE)
...
ttest8 <- t_test(total_data_score ~ time_period, first2020_second2020, paired = FALSE)
