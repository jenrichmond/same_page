...
dataplot1 <- final1A %>% 
  ...
  geom_point(position = position_jitter(width = .15), size = .8) +
     geom_boxplot(aes(x = subfield_groups, y = total_data_score, fill = subfield_groups),outlier.shape = NA, alpha = .5, width = .1, colour = "black")+
  theme_classic() +
...
materialsplot1 <- final1A %>% 
  ...
  geom_flat_violin(position = position_nudge(x = .2, y = 0),adjust =2, alpha = 0.5) +
  geom_point(position = position_jitter(width = .15), size = .8) +
     geom_boxplot(aes(x = subfield_groups, y = total_materials_score, fill = subfield_groups),outlier.shape = NA, alpha = .5, width = .1, colour = "black")+
  theme_classic() +
