...
devcog_data_output <- ttestIS(formula = total_data_score ~ subfield_groups, data = devcog_data)

as.data.frame(devcog_data_output$ttest)
```
...
devsocial_data_output <- ttestIS(formula = total_data_score ~ subfield_groups, data = devsocial_data)

as.data.frame(devsocial_data_output$ttest)
```
...
devother_data_output <- ttestIS(formula = total_data_score ~ subfield_groups, data = devother_data)

as.data.frame(devother_data_output$ttest)
```
...
second2019_first2020_data_output <- ttestIS(formula = total_data_score ~ time_period, data = second2019_first2020)

as.data.frame(second2019_first2020_data_output$ttest)
```
...
first2020_second2020_data_output <- ttestIS(formula = total_data_score ~ time_period, data = first2020_second2020)

as.data.frame(first2020_second2020_data_output$ttest)
```
