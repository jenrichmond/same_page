...
data_summary <- gt(data_percentages) %>%
  ...
  cell_text(color = "black", font = "Times New Roman", size = 12, align = "center")),
  ...
  tab_style(style = list(
    ...
    color = NULL)), # setting the colour to NULL removes the borders entirely 
      locations = cells_body()) %>%
  tab_options(
  table.border.bottom.width = px(0.5), table.border.bottom.color = "black",
  table.border.top.width = px(0.5), table.border.top.color = "black", 
  heading.border.bottom.width = px(0.5), heading.border.bottom.color ="black")
...
materials_summary <- gt(materials_percentages) %>%
  ...
  tab_style(style = list(
    cell_borders(
    sides = c("top", "bottom"), 
    color = NULL)), # setting the colour to NULL removes the internal borders entirely 
      locations = cells_body())
