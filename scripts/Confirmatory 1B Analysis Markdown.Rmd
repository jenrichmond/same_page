...
ez_ANOVA_data # list of 2 items (3x9 df & 1x7 df)

ez_output <- as.data.frame(ez_ANOVA_data[1]) # pull first item
...
study1B_aov$anova_table

study1B_apa <- apa_print(study1B_aov)


```

There was a significant main effect of time period `r study1B_apa$statistic$time_period` and a significant main effect of subfield `r study1B_apa$statistic$subfield_groups`, however, there was no interaction between time period and subfield `r study1B_apa$statistic$time_period_subfield_groups`. 
