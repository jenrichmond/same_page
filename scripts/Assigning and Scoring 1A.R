...
data_scored_for_data <- data_long %>%
  mutate(data_score = case_when("software" == question & "No" == response ~ 0, "software" == question & "Yes" == response ~ 1,
                                ...
                                "how_are_data_accessible" == question & response %in% c("Email authors", "Not clear") ~ 0, "how_are_data_accessible" == question & response %in% c("Public dataset generated by the authors", "Public dataset generated by others", "PS Supplemental Materials", "Other") ~ 2, 
