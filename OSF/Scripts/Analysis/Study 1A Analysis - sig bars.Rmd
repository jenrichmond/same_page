...
d2 <- data_timeperiod_descriptives %>%
  ...
  ggtitle('(b)') +
  geom_signif(comparisons = d2_comparisons, y_position = c(7, 11, 15), tip_length = 0.1, annotation = c("*", "n.s.", "*"), textsize = 3.5, vjust = -0.3) # adding significance bars
...
m1 <- materials_subfield_descriptives %>%
  ...
  ggtitle('(a)') + 
  geom_signif(comparisons = m1_comparisons, y_position = c(7, 11, 15), tip_length = 0.1, annotation = c("*", "*", "n.s."), textsize = 3.5, vjust = -0.3) # adding significance bars
...
m2 <- materials_timeperiod_descriptives %>%
  ...
  ggtitle('(b)') + 
  geom_signif(comparisons = m2_comparisons, y_position = c(7, 11, 15), tip_length = 0.1, annotation = c("n.s.", "n.s.", "*"), textsize = 3.5, vjust = -0.3) # adding significance bars
...
```{r echo=FALSE}
ttest7 <- t_test(open_materials_score ~ time_period, first2014_second2014, paired = FALSE)
...
```{r echo=FALSE}
ttest8 <- t_test(open_materials_score ~ time_period, second2014_first2015, paired = FALSE)
...
```{r echo=FALSE}
ttest9 <- t_test(open_materials_score ~ time_period, first2014_first2015, paired = FALSE)
