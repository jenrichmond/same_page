...
comparisons <- list( c("1st half 2014", "2nd half 2014"), c("2nd half 2014", "1st half 2015"), c("1st half 2014", "1st half 2015") )
...
d2 <- data_timeperiod_descriptives %>%
  ...
  ggtitle('(b)') +
  stat_compare_means(method = "anova", comparisons = comparisons, label = "p.signif", vjust = 0.4, step.increase = 0.5, tip.length = 0.1)
