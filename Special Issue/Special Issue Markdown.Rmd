...
ttest6_A <- t_test(open_data_score ~ time_period, first2014_first2015, paired = FALSE)
...
```{r echo=FALSE}
ttest7_A <- t_test(open_materials_score ~ time_period, first2014_second2014, paired = FALSE)
...
```{r echo=FALSE}
ttest8_A <- t_test(open_materials_score ~ time_period, second2014_first2015, paired = FALSE)
...
```{r echo=FALSE}
ttest9_A <- t_test(open_materials_score ~ time_period, first2014_first2015, paired = FALSE)
...
ttest9_B <- t_test(open_data_score ~ time_period, second2019_second2020, paired = FALSE)
...
ttest7_AB <- t_test(open_data_score ~ time_period, dates_AB, paired = FALSE)
...
ttest8_AB <- t_test(open_materials_score ~ time_period, dates_AB, paired = FALSE)
